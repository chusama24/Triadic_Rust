...
impl TI128 {
   pub fn new(val: i128, d: Triadic) -> Self{
    TI128{value: val, deg: d}
  }

  pub fn set_value(&mut self, val: i128){
    self.value = val;
  }
...
pub fn copy(&self) -> Self{
   TI128{value: self.value, deg: self.deg}
}

}

impl Default for TI128{
    fn default() -> Self{
