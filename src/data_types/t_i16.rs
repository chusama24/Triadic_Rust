...
impl TI16 {
   pub fn new(val: i16, d: Triadic) -> Self{
    TI16{value: val, deg: d}
  }

  pub fn set_value(&mut self, val: i16){
    self.value = val;
  }
...
pub fn copy(&self) -> Self{
   TI16{value: self.value, deg: self.deg}
}

}

impl Default for TI16{
    fn default() -> Self{
